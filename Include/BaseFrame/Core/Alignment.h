...
#ifdef OPENSOFT_ENABLE_CPP11

	#include <type_traits>
	#define OPENSOFT_HAVE_ALIGNMENT
...
// MSVC requires special handling here.
	...
	#ifdef OPENSOFT_COMPILER_CLANG

		#if __has_feature(cxx_alignas)
			#define OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(x) \
	...
	#ifdef OPENSOFT_HAVE_ALIGNMENT
		OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(1);
		OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(2);
		OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(4);
		OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(8);
		OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(16);
		OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(32);
		OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(64);
		OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(128);
		OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(512);
		OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(1024);
		OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(2048);
		OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(4096);
		OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(8192);

		#undef OPENSOFT_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT
	#endif // OPENSOFT_HAVE_ALIGNMENT
...
// OPENSOFT_HAVE_ALIGNMENT will be defined on the pre-C++11 platforms/compilers where
